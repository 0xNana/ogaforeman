...
import { ArrowRight, CircleSlash2, ListTodo, UserRound } from 'lucide-react';
...
export function TaskBoard({ projectId, tasks }: Readonly<{ projectId: string; tasks: Task[] }>) {
  ...
  return (
    <div>
      <div className="page-heading"><div><span className="eyebrow">Lightweight task control</span><h1>Tasks</h1><p>What is moving, what is next and what is stuck.</p></div><div className="page-heading-actions"><Link href={`/projects/${projectId}/site`} className="btn btn-accent btn-small">Tell Oga what changed <ArrowRight size={15} /></Link></div></div>
