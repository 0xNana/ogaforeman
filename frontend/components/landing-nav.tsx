  ...
  return (
    <header className={`site-nav${open ? ' mobile-open' : ''}`}>
      <div className="container site-nav-inner">
        <Link className="logo-lockup" href="/" aria-label="OG Foreman home"><span className="logo-mark" aria-hidden="true" />OG Foreman</Link>
        <nav className="site-nav-links" aria-label="Primary navigation">
          <a href="#how-it-works" onClick={() => setOpen(false)}>How it works</a>
          <a href="#capabilities" onClick={() => setOpen(false)}>What OG handles</a>
