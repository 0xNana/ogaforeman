...
class ReporterAgent:
    ...
    def format_daily_report(self, report: DailyReport) -> dict[str, Any]:
        ...
        return {
            ...
            "crew_summary": report.crew_summary,
            "weather_summary": report.weather_summary,
            "in_progress_work": [fact.model_dump() for fact in report.in_progress_work],
            ...
            "deliveries": [fact.model_dump() for fact in report.deliveries],
            "inspections": [fact.model_dump() for fact in report.inspections],
            "photo_refs": list(report.photo_refs),
